...
#define CODING_ISO_INITIAL(coding, reg)			\
  (XFIXNUM (LRH (AREF (LRH (AREF (LRH (CODING_ID_ATTRS ((coding)->id)),	\
...
syms_of_coding (void)
{
  ...
  staticpro (&Vcoding_category_table, Fmake_vector (make_fixnum (coding_category_max), Qnil));
