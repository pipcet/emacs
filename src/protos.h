...
Lisp_Object CAR(Lisp_Object);
Lisp_Object CDR(Lisp_Object);
Lisp_Object CAR_SAFE(Lisp_Object);
Lisp_Object CDR_SAFE(Lisp_Object);
struct foo *XFRAME(Lisp_Object);
struct foo *XWINDOW(Lisp_Object);
struct foo *XVECTOR(Lisp_Object);
struct foo *XCONS(Lisp_Object);
struct foo *XSTRING(Lisp_Object);
struct foo *XSYMBOL(Lisp_Object);
struct foo *XFLOAT(Lisp_Object);
double XFLOAT_DATA (Lisp_Object);
struct foo *XSUBR(Lisp_Object);
struct foo *XMARKER(Lisp_Object);
struct foo *XBUFFER(Lisp_Object);
struct foo *XFRAME(Lisp_Object);
struct foo *XPROCESS(Lisp_Object);
struct foo *XTHREAD(Lisp_Object);
...
boolean STRING_MULTIBYTE(Lisp_Object);
...
void CHECK_FIXNUM_CAR(Lisp_Object);
void CHECK_FIXNUM_CDR(Lisp_Object);
...
struct foo *LEFT_FRINGE(void *, Lisp_Object, bool);
struct foo *RIGHT_FRINGE(void *, Lisp_Object, bool);
...
void *SAFE_ALLOCA(size_t);
void staticpro(Lisp_Object *, Lisp_Object);
unsigned char *SDATA(Lisp_Object);
char *SSDATA(Lisp_Object);
Lisp_Object SYMBOL_NAME(Lisp_Object);
ssize_t SBYTES(Lisp_Object);
ssize_t SCHARS(Lisp_Object);
void vcopy(Lisp_Object, ptrdiff_t, Lisp_Object *, ptrdiff_t);
