...
bidi_get_type (int ch, bidi_dir_t override)
{
  ...
  default_type = (bidi_type_t) XFIXNUM (LRH (CHAR_TABLE_REF (bidi_type_table, ch)));
...
bidi_paired_bracket_type (int c)
{
  ...
  return (bidi_bracket_type_t) XFIXNUM (LRH (CHAR_TABLE_REF (bidi_brackets_table, c)));
}
...
bidi_explicit_dir_char (int ch)
{
  ...
  ch_type = (bidi_type_t) XFIXNUM (LRH (CHAR_TABLE_REF (bidi_type_table, ch))) ;
